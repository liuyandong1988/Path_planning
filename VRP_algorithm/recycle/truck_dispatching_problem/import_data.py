...
def read_data(filename):
    ...
    return customers, depot, vehicle_count, vehicle_capacity, coordinates, distance_matrix


if __name__ == '__main__':
    file_name = os.path.join(BASE_DIR, 'data\A-n32-k5.vrp') 
    customers, depot, vehicle_count, vehicle_capacity, coordinates, distance_matrix = read_data(file_name)
