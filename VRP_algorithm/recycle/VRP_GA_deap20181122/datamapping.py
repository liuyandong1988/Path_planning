...
class Importer(object):
    ...
    def __init__(self):
        ...
        self.depot = [] #[1,2,3,...]
        self.depot_num = None # the number of depots
        self.customer_num = None # the number of customers
    ...
    def import_data(self, filename):
        ...
        self.depot_num = len(self.depot)
        self.customer_num = len(self.node_coordinates_list) - self.depot_num
...
#         self.network = self._create_network(my_importer.node_coordinates_list, my_importer.demand_array)
    ...
    def _create_fleet(self, capacity, number_of_vehicles=0):
        ...
        fleet = bo.Fleet()
        while (vehicles_left):
            id = number_of_vehicles - vehicles_left 
            vehicle = bo.Vehicle(capacity,id)
...
if __name__ == '__main__':
    ...
    depot_lists = [i-1 for i in depot_lists] # from the number zero
    print depot_lists
#     #depot list
#     Depots = []
