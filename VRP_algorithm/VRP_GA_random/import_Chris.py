...
class Importer(object):
    ...
    def import_data(self, filename):
        ...
        # nametuple customers
        i = 0
        for coord, demand in zip(self.node_coordinates_list, demand_list):
...
def init_data(filename):
    ...
    return customers, depot, vehicle_capacity, vehicle_endurance, service_time, coordinates, distance_matrix


if __name__ == '__main__':
    file_name = os.path.join(BASE_DIR, 'Christofides1979\CMT6.vrp')
    customers, depot, vehicle_capacity, vehicle_endurance, service_time, coordinates, distance_matrix = init_data(file_name)
