...
def init_data(filename):
    ...
    return vehicle_capacity, vehicle_endurance, demand_list, coordination, distance_matrix

if __name__ == '__main__':
    file_name = os.path.join(BASE_DIR, 'Christofides1979\CMT6.vrp')
    vehicle_capacity, vehicle_endurance, demand_list, coordination, distance_matrix = init_data(file_name)
